...
public class Menu extends javax.swing.JFrame {
    ...
    private void DatPhongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DatPhongActionPerformed
        DatPhongView datPhong = new DatPhongView();
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        JOptionPane.showMessageDialog(rootPane, "Nhấn Ok để có thể tắt chương trình", "Backup problem", JOptionPane.ERROR_MESSAGE);
